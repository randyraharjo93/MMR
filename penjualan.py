...
class mmr_penjualanpodetil(osv.osv):
    ...
    _columns = {
        ...
        'rayon': fields.many2one("mmr.rayon", "Rayon PO", related='idpenjualanpo.rayon', domain="[('aktif', '=', True)]"),
...
def validasipenjualansj(self, cr, uid, id, context=None):
    ...
    if len(objini.penjualansjdetil) > 0:
        for semuapenjualansjdetil in objini.penjualansjdetil:
            if semuapenjualansjdetil.pilihanproduk in listproduk2:
        ...
        for semuastokkeluar in objini.stokkeluar:
            if semuastokkeluar.pilihanproduk in listproduk2:
                listproduk2[semuastokkeluar.pilihanproduk] -= semuastokkeluar.jumlah
            else:
